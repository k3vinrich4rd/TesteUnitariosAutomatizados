...
public class CalculoTest {
    ...
    @Test
    @DisplayName("O teste deverá retornar o resultado de um calculo de uma soma")
    ...
    @Test
    @DisplayName("O teste deverá retornar uma mensagem de exceção")
    ...
    @Test
    @DisplayName("O teste deverá retornar o calculo de uma raiz quadrada")
    ...
    @Test
    @DisplayName("O teste deverá retorna true se o número informado for impar")
    ...
    @Test
    @DisplayName("O teste deverá retornar true, se o número informado for par")
